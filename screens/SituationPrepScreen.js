...
const SITUATIONAL_OPENERS = {
  ...
  School: [
    {
      opener:
        "Hey, are you in [class]? I'm trying to find someone to study with.",
      ...
      donts: [
        "Be pushy",
        "Make it obvious you're hitting on them",
        "Interrupt their studying",
      ],
    },
    {
      opener:
        "Excuse me, do you know where [building/room] is? I'm a bit lost on campus.",
    ...
    {
      opener:
        "Hey, I noticed you're studying [subject]. I'm taking that class too. How's it going?",
  ...
  Misc: [
    {
      ...
      dos: ["Be genuine", "Keep it brief", "Respect their response"],
    ...
    {
      opener:
        "Hey, do you have a minute? I noticed [something specific] and wanted to say hi.",
                ...
                <View className="flex-row justify-end">
                  <TouchableOpacity
                    ...
                    style={{
                      ...
                      borderRadius: 8,
                      backgroundColor: theme.textSecondaryRgba(0.1),
                      borderWidth: 1,
